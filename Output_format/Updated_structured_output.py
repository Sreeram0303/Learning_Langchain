...
class Review(TypedDict):
    key_themes : Annotated[list[str], "Write all the key themes in the content, separated by commas in a list format"]
    summary: Annotated[str, "Summary of the content"]
    sentiment: Annotated[Literal["positive","negative"], "Sentiment of the content, e.g., positive, negative, neutral"]
    pros : Annotated[Optional[list[str]], "List of pros in the content, if any, otherwise empty list"]
    cons : Annotated[Optional[list[str]], "List of cons in the content, if any, otherwise empty list"]
